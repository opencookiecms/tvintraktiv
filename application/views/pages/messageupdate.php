    ...
    <div class="box box-info">
      ...
      <div class="box-body">
        <div class="form-group">
          ...
          <div class="col-sm-2">
            <input type="text" class="form-control" name="hiddenid" value="<?php echo $get_message[0]->id ?>" readonly>
          </div>
        </div>
      ...
      <div class="box-body">
        <div class="form-group">
          ...
          <textarea class="ckeditor" name="content"><?php echo $get_message[0]->message_content ?></textarea>
          <script>
